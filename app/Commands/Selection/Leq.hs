...
iFilterFromType Int value = Just (PTFilter.compareInt (<= value), PTFastFilter.leqInt value)
iFilterFromType Int8 value = Just (PTFilter.compareIntX (True, False, False, False) (<= value), PTFastFilter.i8Leq (fromIntegral value))
iFilterFromType Int16 value = Just (PTFilter.compareIntX (False, True, False, False) (<= value), PTFastFilter.i16Leq (fromIntegral value))
iFilterFromType Int32 value = Just (PTFilter.compareIntX (False, False, True, False) (<= value), PTFastFilter.i32Leq (fromIntegral value))
iFilterFromType Int64 value = Just (PTFilter.compareIntX (False, False, False, True) (<= value), PTFastFilter.i64Leq (fromIntegral value))
